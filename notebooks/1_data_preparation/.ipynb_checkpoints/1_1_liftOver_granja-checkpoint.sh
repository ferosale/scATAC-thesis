#!/usr/bin/env bash
# This shell script is used to transfer the granja data from hg19 format to the hg38 format, to match our collaborators data. 
# To be used before running any processing.
