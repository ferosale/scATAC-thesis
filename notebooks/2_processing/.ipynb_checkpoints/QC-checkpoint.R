...
# Filter all cells not passing QC. This is required since ArchR does not do this during arrow creation (BUG?)
minTSS   <- 8
minFrags <- 1000
...
# As explained above, this step is required to remove cells that did not pass the initial filtering step, but were not excluded
